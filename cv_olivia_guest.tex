...
\begin{description}
 \item [Phone:] (+44) (0)7842 868199 (UK)
...
\textbf{Guest, O.}, Love, B. C. (in press). What the Success of Brain Imaging Implies about the Neural Code.
\vspace{5pt}
...
\textbf{General:} \href{http://oliviaguest.com/license/}{Website design} (HTML, CSS, CMS, Jekyll, Liquid, YAML); Graphic design (Adobe CS); GUI design (PyGTK, GTK+).
\vspace{10pt}
