...
\begin{center}\fontsize{35}{60}{\selectfont{\scshape\hspace{-16mm}#1}}\end{center}
\vspace{10pt}
}
...
\textbf{Phone:} (+44) (0)7842868199 (UK)
\begin{description}
...
\begin{outerlist}
\item[\textit{Postdoctoral Researcher}] \hfill \textbf{2014-}
...
\textbf{Guest, O.}, Rougier, N. P. (in press). What is computational reproducibility? \textit{IEEE CIS Newsletter on Cognitive and Developmental Systems.} [\href{https://www.overleaf.com/read/nsndhzbpvwky}{preprint}]
\vspace{5pt}
...
\href{http://software.ac.uk/}{Software Sustainability Institute}, \href{http://www.manchester.ac.uk/}{University of Manchester} \hfill \textbf{28 Jul 2016}
\begin{innerlist}
...
\href{http://cccm.bbk.ac.uk/}{CCCM}, Birkbeck         \hfill \textbf{23-25 Apr 2014}
\begin{innerlist}
...
\textbf{Programming:} Ada, C, C$++$, C\#, Java, JavaScript, \LaTeX, MATLAB,  OpenGL, Pascal, PHP, Prolog, Python, R, Scheme, SQL, Visual Basic.
\end{document}
%%%%%%%%%%%%%%%%%%%%%%%%%% End CV Document %%%%%%%%%%%%%%%%%%%%%%%%%%%%%